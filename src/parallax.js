function parallaxMethod() {
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function parallaxMove(left, top, x, y, speed ) {
          ...
          obj.style.left = left -150- ( ( ( x - ( parseInt( obj.offsetWidth ) / 2 + left ) ) / containerWidth ) * (speed+50)) + 'px';
          obj.style.top = top +500- (((y - (parseInt(obj.offsetHeight) /2 + top)) / containerHeight) * speed) + 'px';
